...
<div class="min-h-screen flex">
    ...
    <div class="flex-1 flex justify-center items-center p-6 sm:p-12 bg-white">
        <div class="w-full max-w-md space-y-8">
            ...
            <form class="space-y-5" action="<?= site_url('register') ?>" method="post">
                ...
                <div class="space-y-1.5">
                    ...
                    <input
                        ...
                        required
                        autocomplete="name"
                        class="w-full bg-zinc-50 border border-zinc-200 rounded-xl px-4 py-3.5 focus:outline-none focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10">
                </div>
                ...
                <button
                    type="submit"
                    class="w-full bg-zinc-950 hover:bg-zinc-900 text-white py-3.5 rounded-xl text-sm font-semibold">
                    Daftar
                </button>
