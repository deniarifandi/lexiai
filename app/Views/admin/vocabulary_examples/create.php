...
<div class="max-w-5xl mx-auto space-y-6">
    ...
    <form action="<?= base_url('admin/vocabulary-examples/store') ?>" method="post">
        ...
        <div class="bg-white rounded-xl border border-zinc-200 shadow-sm p-8 space-y-6">
            ...
            <div>
                ...
                <textarea
                    ...
                    placeholder="Example: Farmers use fertilizer to improve crop production."><?= old('sentence') ?></textarea>
            ...
            <div>
                ...
                <textarea
                    ...
                    rows="3"
                    class="w-full border border-zinc-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-zinc-900 focus:outline-none"
                    placeholder="Contoh: Petani menggunakan pupuk untuk meningkatkan hasil panen."><?= old('translation') ?></textarea>
