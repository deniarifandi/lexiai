...
<div class="max-w-5xl mx-auto space-y-6">
    ...
    <form action="<?= base_url('admin/reading-questions/update/'.$question['id']) ?>" method="post">
        ...
        <div class="bg-white border border-zinc-200 rounded-xl p-6 space-y-6">
            ...
            <div>
                ...
                <textarea
                    ...
                    rows="4"
                    required
                    class="w-full rounded-lg border border-zinc-300 px-4 py-3 focus:ring-2 focus:ring-zinc-900 focus:border-zinc-900"><?= old('question', $question['question']) ?></textarea>
            ...
            <div>
                ...
                <textarea
                    ...
                    rows="8"
                    required
                    class="w-full rounded-lg border border-zinc-300 px-4 py-3 focus:ring-2 focus:ring-zinc-900 focus:border-zinc-900"><?= old('reference_answer', $question['reference_answer']) ?></textarea>
            ...
            <div>
                ...
                <input
                    type="text"
                    name="keywords"
                    value="<?= old('keywords', $question['keywords']) ?>"
